...
- **Long-horizon training systems:** the *GLM-5* and *Composer 2* technical reports. Use them to study asynchronous rollout/training infrastructure, policy staleness, long trajectories, compaction or self-summarization, and training--inference consistency.
