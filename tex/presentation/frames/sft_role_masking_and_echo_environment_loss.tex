  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.38\textwidth}
      ...
      \begin{tikzpicture}[node distance=1.5mm]
        ...
        \node[flowbox,text width=42mm,minimum height=8mm,inner sep=1mm,below=of assistant1] (tool)
          {\textbf{Tool result}\quad \textcolor{DeckMuted}{$m=0$: masked}\\[-1mm]
           \scriptsize \texttt{not\_found}};
