...
Training begins with complete token sequences. In
\texttt{[BOS, I, like, tea, EOS]}, the \texttt{BOS} and \texttt{EOS} tokens mark the
beginning and end of the sequence. The input at each position predicts the token
immediately to its right. This creates four
