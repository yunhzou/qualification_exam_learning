...
downstream choices. OPD converts this semantic intervention into a token-distribution
...
hint identifies the causal correction, and OPD or SFT turns that correction into a
