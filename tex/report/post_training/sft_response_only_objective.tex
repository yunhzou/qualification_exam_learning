...
effective accumulated batch. Here gradient accumulation means combining gradients from
several microbatches before one optimizer step \citep{huggingface2026gradientaccumulation,
