...
The current working plan is to select five central papers on LLM post-training. This is the lower end of the handbook's permitted range and should be confirmed with the supervisor.
...
- A supervisor-approved list of 5-10 core papers, with five papers as the current target.
